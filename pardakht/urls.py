...
from .views import add_to_cart,remove_from_cart,reduction_from_cart,set_qty_in_cart,CartDetailView,AddressListView
...
urlpatterns = [
    ...
    path('checkout/', AddressListView.as_view(), name='checkout'),
